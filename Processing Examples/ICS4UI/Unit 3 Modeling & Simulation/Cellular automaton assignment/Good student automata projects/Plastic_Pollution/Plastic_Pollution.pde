...
float plasticChance = 0.75;			// CHANCE OF PLASTIC TO BE DROPPED BY THE HUMAN IN EACH GENERATION (DEFAULT IS 50%)
float microplasticChance = 0.8;		// CHANCE OF EACH PLASTIC DROPPED BEING A MICROPLASTIC (DEFAULT IS 90%)
